    ...
    <div className={styles.flightTicket}>
      <div className={styles.ticketBase} onClick={openModal}>
        ...
        <div className={styles.flightInfoContainer}>
          <div className={styles.flightTagContainer}>
            <Tag
          ...
          <div className={styles.flightInfoRow}>
            ...
            >
              ...
              <div className={styles.departureInfoFlight}>
                <h5 className={styles.departureInfoFlightTitle}>
                  Flight Information
                </h5>
                <p className={styles.departureInfoText}>
                  Airport: {`${flight["Departure Airport"]}`}
                </p>
                <p className={styles.departureInfoText}>Flight: N/A</p>
                <p className={styles.departureInfoText}>
                  Confirmation Number: N/A
                </p>
              </div>
              <div className={styles.departureInfoTravel}>
                <h5 className={styles.departureInfoTravelTitle}>
                  Travel Information
                </h5>
                <p className={styles.departureInfoText}>Departure Time: N/A</p>
                <p className={styles.departureInfoText}>Boarding Time: N/A</p>
              </div>
              <div className={styles.departurePassengerText}>
                <p>Passenger(s): {`${flight["Passenger Names"]}`}</p>
              </div>
            </div>
            ...
            >
              ...
              <Divider spacing={DividerSpacing.SMALL} />
              <div className={styles.arrivalInfoFlight}>
                <h5 className={styles.arrivalInfoFlightTitle}>
                  Flight Information
                </h5>
                <p className={styles.arrivalInfoText}>
                  Airport: {`${flight["Arrival Airport"]}`}
                </p>
                <p className={styles.arrivalInfoText}>Flight: N/A</p>
                <p className={styles.arrivalInfoText}>
                  Confimation Number: N/A
                </p>
              </div>
              <div className={styles.arrivalInfoTravel}>
                <h5 className={styles.arrivalInfoTravelTitle}>
                  Travel Information
                </h5>
                <p className={styles.arrivalInfoText}>Arrival Time: N/A</p>
              </div>
              <div className={styles.arrivalPassengerText}>
                <p>Passenger(s): {`${flight["Passenger Names"]}`}</p>
              </div>
            </div>
          </div>
